...
const MAGIC_LINK_API_KEY = process.env.NEXT_PUBLIC_MAGIC_CONNECT_API_KEY || undefined
...
export const rainbowMagicConnector = ({ chains }: WalletConnectWalletOptions): Wallet => ({
    id: 'magic',
    name: 'Magic',
